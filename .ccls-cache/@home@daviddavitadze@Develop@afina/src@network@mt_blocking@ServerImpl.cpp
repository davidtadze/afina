...
void ServerImpl::Start(uint16_t port, uint32_t n_accept, uint32_t n_workers) {
    ...
    // TODO:
    // read about what type of masks exist
    sigset_t sig_mask;
    ...
    // TODO:
    // read about socket initialization and options
    ...
    // QUESTION:
    // what's the difference between volatile, {}, atomic?
    // and what to use best?
    running.store(true);
...
void ServerImpl::Join() {
    ...
    _active_workers.wait(lk, [this] { return this->_workers == 0; });
}
